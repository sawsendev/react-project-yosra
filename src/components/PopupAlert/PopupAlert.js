...
const PopupAlert = (isPopupOpen) => {
  ...
  const handleFormSubmit = (event) => {
    ...
    // Par exemple, effectuer une requête pour enregistrer les données
  }

  if (!isPopupOpen) {
    return null; // Si isPopupOpen est faux, n'affiche rien
  }

  return (
    <div className={`popup-container ${close ? 'open' : 'closed'}`}>
